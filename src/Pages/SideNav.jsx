            ...
            <div className={`md:w-[280px] pt-3 bg-[#0F0F0F]  mt-12 ${menu} `}>
                <div className='lg:w-full h-full  md:block overflow-y-auto overflow-x-hidden'>
                                        ...
                                        <Link to={`/channel/${subscribe.id}`} key={subscribe.id}>
                                            <li className='flex flex-row justify-start items-center gap-4 text-white py-2 px-4 rounded-lg hover:bg-[#686868b5] cursor-pointer'>
                                                <img src={subscribe.img} width={25} height={25} className='rounded-full'
                                                    onClick={() => { setchannelInfo(subscribe.id); console.log(subscribe.id) }} />
                                                <p>{subscribe.title}</p>
                                            </li>
                                        </Link>
                                    )
                    ...
                    <ul className='w-full px-2 pb-2 border-b py-1'>
                        ...
                        <li className='flex flex-row justify-start items-center gap-4 text-white py-2 px-4 rounded-lg hover:bg-[#686868b5] cursor-pointer' onClick={() => handleCategoryClick(0)}>
                            <BsFire style={{ width: "20px", height: "20px", color: "white" }} />
                            <p>Trending</p>
                        </li>
                        <li className='flex flex-row justify-start items-center gap-4 text-white py-2 px-4 rounded-lg hover:bg-[#686868b5] cursor-pointer' onClick={() => handleCategoryClick(10)}>
                            <PiMusicNoteLight style={{ width: "20px", height: "20px", color: "white" }} />
                            <p>Music</p>
                        </li>
                        <li className='flex flex-row justify-start items-center gap-4 text-white py-2 px-4 rounded-lg hover:bg-[#686868b5] cursor-pointer' onClick={() => handleCategoryClick(20)}>
                            <IoGameController style={{ width: "20px", height: "20px", color: "white" }} />
                            <p>Gaming</p>
                        </li>
                        <li className='flex flex-row justify-start items-center gap-4 text-white py-2 px-4 rounded-lg hover:bg-[#686868b5] cursor-pointer' onClick={() => handleCategoryClick(28)}>
                            <FaWifi style={{ width: "20px", height: "20px", color: "white" }} />
                            <p>Tech</p>
                        </li>
                        <li className='flex flex-row justify-start items-center gap-4 text-white py-2 px-4 rounded-lg hover:bg-[#686868b5] cursor-pointer' onClick={() => handleCategoryClick(25)}>
                            <ImNewspaper style={{ width: "20px", height: "20px", color: "white" }} />
                            <p>News</p>
                        </li>
                        <li className='flex flex-row justify-start items-center gap-4 text-white py-2 px-4 rounded-lg hover:bg-[#686868b5] cursor-pointer' onClick={() => handleCategoryClick(17)}>
